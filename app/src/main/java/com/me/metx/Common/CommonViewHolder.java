...
public class CommonViewHolder {
    ...
    public void setTextForTextView(int textViewId, CharSequence text) {
        TextView textView = (TextView) mContentView.findViewById(textViewId);
        if (textView != null) {
    ...
    public void setImageForView(int imageViewId, int drawableId) {
        ImageView imageView = (ImageView) mContentView.findViewById(imageViewId);
        if (imageView != null) {
    ...
    public void setCheckForCheckBox(int checkViewId, boolean isCheck) {
        CheckBox checkBox = (CheckBox) mContentView.findViewById( checkViewId);
        if (checkBox != null) {
